...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js":[function(require,module,exports) {
var define;
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/render-HTML.js":[function(require,module,exports) {
"use strict";
...
function renderCards(r, page) {
  ...
  if (qty === total) {
    _notiflix.default.Notify.warning("We're sorry, but you've reached the end of search results.");
...
},{"notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js","simplelightbox":"../node_modules/simplelightbox/dist/simple-lightbox.modules.js","simplelightbox/dist/simple-lightbox.min.css":"../node_modules/simplelightbox/dist/simple-lightbox.min.css"}],"js/fech.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = fechApi;
...
async function fechApi(text, page) {
  ...
  await _axios.default.get(`https://pixabay.com/api/?${KEY}&q=${text}${options}`).then(function (response) {
    (0, _renderHTML.default)(response, page);
  }).catch(function (error) {
    // handle error
    console.log(error);
  }).then(function () {});
}
},{"axios":"../node_modules/axios/index.js","./render-HTML":"js/render-HTML.js"}],"js/input-form.js":[function(require,module,exports) {
"use strict";

var _fech = _interopRequireDefault(require("./fech"));
...
function onFech() {
  (0, _fech.default)(text, page);
} // window.addEventListener("scroll", () => {
//   const doc = document.documentElement.getBoundingClientRect();
//   if (doc.bottom < document.documentElement.clientHeight + 200) { })
},{"./fech":"js/fech.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./js/input-form");
},{"./js/input-form":"js/input-form.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
